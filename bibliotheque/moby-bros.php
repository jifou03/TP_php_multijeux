...
<?php
$moby =array(
    'lien' => '../js/moby-bros-l-aventurier-des-etoiles/moby2.htm',
...
?>
<a href="<?php echo $moby['lien'] ?>" class="lien_image">
    <img src="<?php echo $moby['src'] ?>" alt="<?php echo $moby['alt'] ?>" class="imgcontour"/>
</a>

<p class="description_jeux">
    <?php echo $moby['description'] ?>
 </p>

<p class="jouer"><a href="<?php echo $moby['lien'] ?>">JOUER</a></p>

<p class="titre_jeux"><?php echo $moby['nom_jeux'] ?></p>

<p>

    <a href="moby-bros.php?thumb=up"><img src=" ../images/<?php echo $thumb_is_up? 'like0.png' : 'like.png'?>"
                                            alt="<?php echo $moby['alt'] ?>" id="img1" class="like" "/></a>

    <a href="moby-bros.php?thumb=down"><img src="../images/<?php echo $thumb_is_down? 'unlike0.png' : 'unlike.png'?>"
                                              alt="<?php echo $moby['alt'] ?>" id="img2" class="likes" /></a>
</p>
